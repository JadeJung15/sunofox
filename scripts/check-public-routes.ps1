...
$routes = @(
  ...
  @{
    ...
    Must = @("EPISODE 01", "novel-reader-summary", "novel-reader-jumpbar", "novel-reader-index", "article:published_time", "BreadcrumbList", "https://sunofox.com/novels/episode-001/")
  },
  @{
    Name = "episode-002"
    Path = "/novels/episode-002/"
    File = "novels/episode-002/index.html"
    Must = @("EPISODE 02", "novel-reader-summary", "novel-reader-jumpbar", "novel-reader-index", "article:published_time", "BreadcrumbList", "https://sunofox.com/novels/episode-002/")
  },
  @{
    Name = "episode-003"
    Path = "/novels/episode-003/"
    File = "novels/episode-003/index.html"
    Must = @("EPISODE 03", "novel-reader-summary", "novel-reader-jumpbar", "novel-reader-index", "article:published_time", "BreadcrumbList", "https://sunofox.com/novels/episode-003/")
  },
  @{
    Name = "episode-004"
    Path = "/novels/episode-004/"
    File = "novels/episode-004/index.html"
    Must = @("EPISODE 04", "novel-reader-summary", "novel-reader-jumpbar", "novel-reader-index", "article:published_time", "BreadcrumbList", "https://sunofox.com/novels/episode-004/")
  },
  @{
    Name = "episode-005"
    Path = "/novels/episode-005/"
    File = "novels/episode-005/index.html"
    Must = @("EPISODE 05", "novel-reader-summary", "novel-reader-jumpbar", "novel-reader-index", "article:published_time", "BreadcrumbList", "https://sunofox.com/novels/episode-005/")
  },
  @{
    Name = "episode-006"
    Path = "/novels/episode-006/"
    File = "novels/episode-006/index.html"
    Must = @("EPISODE 06", "novel-reader-summary", "novel-reader-jumpbar", "novel-reader-index", "article:published_time", "BreadcrumbList", "https://sunofox.com/novels/episode-006/")
  },
  @{
    Name = "music"
    Path = "/music/"
