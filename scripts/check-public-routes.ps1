...
$routes = @(
  ...
  @{
    ...
    Must = @("EPISODES", "novel-list-toolbar", "novel-list-featured", "novel-list-actions", "/novels/episode-001/", "/novels/episode-006/", "novel-world-section", "novel-character-section", "BreadcrumbList", "https://sunofox.com/novels/")
  },
  @{
    Name = "episode-001"
