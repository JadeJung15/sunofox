...
| `/music/` | Music Archive / YouTube-MV 허브 | `src/pages/music/index.astro` | 200, 대표 OST, 앨범, 영상 허브 CTA/대표 카드 마커, 유형별 빠른 이동 |
...
| `/updates/` | 공식 업데이트 로그 | `src/pages/updates.astro` | 200, 고정 공지, 카테고리 허브, 확장 현황 확인 필요 항목, 카테고리별 기록, 최근 업데이트 |
