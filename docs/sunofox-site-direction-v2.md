...
Latest channel snapshot: 2026-07-05
...
| 항목 | 기준 |
|---|---|
| 공식 피드 | `https://www.youtube.com/feeds/videos.xml?channel_id=UC8M-2aXbknDT3tDcN1PMvuQ` |
| 최신 공개 | `2026.07.01` 웹소설 OST EP.04 `아직 데려가지 마` |
| 최신 4개 | `아직 데려가지 마`, `끝났다고 말해`, `신호가 희미해져`, `감지된 오류` |
| 채널 규모 | YouTube 검색 스니펫 기준 `구독자 약 4.28K명 · 영상 137편` |
| 보조 스냅샷 | Playboard 공개 정보 기준 조회수 `92만+` 수준 |
