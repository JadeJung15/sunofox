...
$routes = @(
  ...
  @{
    ...
    Must = @("Music Archive", "MUSIC", "ARCHIVE", "music-video-direct-actions", "music-featured-ost-section", "music-release-card", "music-link-hub-section", "musicLinkHub", "music-link-card", 'data-link-group="album"', 'data-link-group="streaming"', 'data-link-group="channel"', "music-video-feature", "music-video-hub", "music-video-summary", "music-video-anchor-strip", "music-video-2KsAbBnf2Lk", "music-video-u_OwBr3Cstk", "music-video-grid", 'data-video-action="latest"', 'data-video-action="channel"', 'data-video-action="playlists"', 'data-video-feature="2KsAbBnf2Lk"', 'data-video-id="2KsAbBnf2Lk"', 'data-video-card="2KsAbBnf2Lk"', 'data-video-type="Web Novel OST"', "https://www.youtube.com/@sunofox", "https://www.youtube.com/@sunofox/playlists", "https://music.youtube.com/channel/UCjPuy8z0pdzW3OVUXka0lMw", "https://open.spotify.com/artist/5fzr4xqw1e0c5cI8dVj11D", "https://www.genie.co.kr/detail/albumInfo?axnm=87219242", "https://www.youtube.com/watch?v=u_OwBr3Cstk", "https://www.youtube.com/watch?v=2KsAbBnf2Lk", "https://sunofox.com/music/")
  },
  @{
    Name = "album"
